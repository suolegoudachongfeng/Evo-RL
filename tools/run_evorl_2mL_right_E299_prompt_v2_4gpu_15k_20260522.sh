...
DATASET_REPO="nero_task3_step1/2mL_right_E249_plus_dagger50_prompt_v2_evorl_20260521"
DATASET_ROOT="/mnt/project_eai/chp/datasets/converted_datasets/nero_task3_step1/2mL_right_E249_plus_dagger50_prompt_v2_evorl_20260521"
...
echo "===== EvoRL E299 pipeline start: $(date) ====="
echo "RUN_ID=$RUN_ID"
echo "DATASET_REPO=$DATASET_REPO"
echo "DATASET_ROOT=$DATASET_ROOT"
echo "POLICY_STEPS=15000"
...
echo "===== PI05 policy full train: $(date) ====="
"$PY" -m accelerate.commands.launch \
  --num_processes 4 \
  --num_machines 1 \
  --mixed_precision bf16 \
...
echo "===== EvoRL E299 pipeline finished: $(date) ====="
