...
RUN_ID="2mL_right_E299_prompt_v2_from_E249_evorl_lora_r16_20260522_2gpu_5k"
...
echo "===== Resume LoRA E299 policy 5k -> 10k: $(date) ====="
...
# For PEFT resume, train_config already contains the adapter path and PEFT config.
...
echo "===== Resume LoRA E299 policy finished: $(date) ====="
